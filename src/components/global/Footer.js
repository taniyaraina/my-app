...
const navigation = {
  ...
  contacts: [
    ...
    { title: 'Emails', description: 'michelle.rivera@idstudio.com' },
    { title: 'Phones', description: '(808) 555-0111 or (303) 555-0105' },
  ],
  company: [
    { name: 'About', href: '#' },
    { name: 'Blog', href: '#' },
    ...
    <Container>
      ...
      <div className="lg:flex lg:justify-between">
        <div className="space-y-16 xl:col-span-1 max-w-sm">
          <a href="#">
            {' '}
            <Image height={25} width={130} src="/images/logo.png" alt="" />
          </a>{' '}
          <p className="text-base textSecondaryColor leading-7">
          ...
          <p className="text-base textSecondaryColor">
        ...
        <div className="">
          ...
          <ul role="list" className="mt-4 space-y-12">
            {navigation.contacts.map((item) => (
              <li key={item.name}>
                <p className="text-base textLite uppercase">{item.title}</p>
                <p className="textSecondaryColor text-base">
                  {item.description}
                </p>
              </li>
            ))}
